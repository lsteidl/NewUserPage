...
* Password: Any String, password fields must match.
             ...
             <form id="signUpForm" className="needs-validation" align="center" noValidate onSubmit={handleSubmit(onSubmit)}>
                      ...
                      <div className="has-validation text-start position-relative">
                        ...
                        <div className="has-validation text-start position-relative">
                          ...
                          <input type="password" className="form-control transparent-input text-white" id="validationPassword1"
                        ...
                        <div className="has-validation text-start position-relative">
                          ...
                          <input type="password" className="form-control transparent-input text-white" id="validationPassword2"
                          required {...register("password")}></input>
                          <div className="valid-tooltip position-absolute top-100 end-0 text-nowrap">
                            Looks good!
                          </div>
                          <span className="invalid-tooltip position-absolute top-100 end-0 text-nowrap">
                    ...
                    <div id="submitDiv" className="pt-5 d-grid">
                      <button id="submitButton" className="btn text-white btn-outline-light btn-block" type="submit" >Submit form</button>
